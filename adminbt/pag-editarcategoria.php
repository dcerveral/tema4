...
<?
					...
					$consulta="select* from categorias where id=".$_GET['id']." order by id DESC limit 100;";
    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="form-group">
				...
				if ($campo[0]=$not[0]) {echo "selected";}
			  ...
			  <?
				...
				echo " 
					<div id='imagen'   >	
						...
						<div id='cargados'  >
							<img id='banner' class=' img-thumbnail'  style='width:100%;'  src='".$folderAdmin."/imgcat.php?id=".$_GET['id']."&".date('is')."'   onerror=\"this.src='".$folderAdmin."/sin_foto.jpg';\"> 
...
Req.open("POST", "<? echo $folderAdmin; ?>/ajax-subirfotocat.php", true);
