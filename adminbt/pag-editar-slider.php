<?
					...
					$consulta="select * from sliders where id=".$_GET['id']." order by id DESC limit 100;";
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <div class="box-tools pull-right">
               <form action='<? echo $folderAdmin; ?>/slider/<? echo $_GET['tipo']; ?>?<? echo rand(111,999); ?>' method='POST'>
			  ...
			  <?
				...
				echo " 
					<div id='imagen'   >	
						...
						<div id='cargados'  >
							<img id='banner' class=' img-thumbnail'  style='width:100%;'  src='".$folderAdmin."/img.php?id=".$_GET['id']."&tabla=sliders&".rand(111,999)."'    onerror=\"this.src='".$folderAdmin."/sin_foto.jpg';\"> 
...
Req.open("POST", "<? echo $folderAdmin; ?>/ajax-subirfoto.php?tabla=sliders", true);
