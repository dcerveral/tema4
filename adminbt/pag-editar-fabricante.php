<?
					...
					$consulta="select * from fabricantes where id=".$_GET['id']." limit 1;";
...
<section class="content-header">
	...
	<form action='<? echo $folderAdmin; ?>/fabricantes/?<? echo date('im'); ?>' method='POST' enctype="multipart/form-data">
		...
		<div class="form-group">
            <input type="hidden" class="form-control" value='<? echo $not[0]; ?>' name='id' >
        </div>
...
Req.open("POST", "<? echo $folderAdmin; ?>/ajax-subirfoto.php?tabla=fabricantes", true);
