    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="form-group">
                  ...
                  <input type="text"   class="form-control" name='pais' id="pais" value="Espa&ntilde;a" placeholder="Espa&ntilde;a" >
        </div>
		...
		<!--div class="form-group">
		 ...
		 <div class="form-group">
                  ...
                  <input type="text" style="text-transform:lowercase;" class="form-control" name='isoidioma' id="isoidioma" value="es" placeholder="es" >
        </div>
		...
		<div class="form-group">
                  ...
                  <input type="text" style="text-transform:lowercase;"  class="form-control" name='moneda' id="moneda" value="EUR" placeholder="EUR" >
        </div>
		<div class="form-group">
                  <label for="cambio">Cambio</label>
                  <input type="number"   class="form-control" name='cambio' id="cambio" value="1"  >
        </div>
		
		<div class="form-group">
                  <label for="general">Impuesto General</label>
                  <input type="number"   class="form-control" name='general' id="general" value="21"  >
        </div>
		
		<div class="form-group">
                  <label for="reducido">Impuesto Reducido</label>
                  <input type="number"   class="form-control" name='reducido' id="reducido" value="10"  >
        </div>
		
		<div class="form-group">
                  <label for="superreducido">Impuesto Super-Reducido</label>
                  <input type="number"   class="form-control" name='superreducido' id="superreducido" value="4"  >
        </div>
