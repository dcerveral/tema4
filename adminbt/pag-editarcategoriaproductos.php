...
<?
					...
					$consulta="select* from categoriasproductos where id=".$_GET['id']." order by id DESC limit 100;";
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <div class="box-tools pull-right">
               <form action='<? echo $folderAdmin; ?>/categorias-productos' method='POST'>
		...
		<div class="form-group">
                  ...
                  <input type="text" class="form-control" name='titulo' value="<? echo $not['categoria']; ?>" id="titulo" placeholder="Titulo" required>
        </div>
		
		<div class="form-group">
                  <label for="descripcion">Descripci&oacute;n</label>
                  <input type="text" class="form-control" name='descripcion' id="descripcion" value="<? echo $not['descripcion']; ?>" placeholder="Descripci&oacute;n" >
        </div>
		...
		<div class="form-group">
                ...
                <select class="form-control select2" name="superior"  style="width: 100%;">
                  ...
                  <? //LISTAMOS TODAS LAS CATEGORIAS
						...
						$consulta="select *  from categoriasproductos ORDER BY superior,categoria ";
				 
				$sql=mysql_query($consulta,$conex);
				while($campo=mysql_fetch_array($sql)){
				
				echo "<option value='".$campo[0]."' ";
				if ($campo[0]==$not['superior']) {echo " selected";}
			  ...
			  <?
				...
				echo " 
					<div id='imagen'   >	
						...
						<div id='cargados'  >
							<img id='banner' class=' img-thumbnail'  style='width:100%;'  src='".$folderAdmin."/imgcatprod.php?id=".$_GET['id']."&".date('is')."'   onerror=\"this.src='".$folderAdmin."/sin_foto.jpg';\"> 
...
Req.open("POST", "<? echo $folderAdmin; ?>/ajax-subirfotocatprod.php", true);
